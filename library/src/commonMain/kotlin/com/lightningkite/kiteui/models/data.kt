...
public data class FontAndStyle(
    public val font: Font = systemDefaultFont,
    public val italic: Boolean = false,
    public val weight: Int = 400,
    public val allCaps: Boolean = false,
    public val lineSpacingMultiplier: Double = 1.4,
    public val additionalLetterSpacing: Dimension = 0.px,
    public val size: Dimension = 1.rem,
    ...
    public val bold: Boolean get() = weight >= 700
}

public data class Icon(
    public val width: Dimension, val height: Dimension,
    public val viewBoxMinX: Int = 0, val viewBoxMinY: Int = 0, val viewBoxWidth: Int = 24, val viewBoxHeight: Int = 24,
    public val pathDatas: List<String> = listOf(),
    public val strokePathDatas: List<StrokePathData> = listOf(),
) {
    public enum class StrokeLineCap { Butt, Round, Square }
    public data class StrokePathData(
        public val strokeWidth: Dimension,
        public val path: String,
        public val strokeLineCap: StrokeLineCap = StrokeLineCap.Butt,
        public val fill: Paint? = null
    )

    public fun toImageSource(color: Paint): ImageVector = ImageVector(
        width,
        height,
        viewBoxMinX,
        viewBoxMinY,
    ...
    public companion object {
        ...
        public val arrowBack: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val moreHoriz: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val deleteForever: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val remove: Icon = Icon(1.5.rem, 1.5.rem, 0, -960, 960, 960, listOf("M200-440v-80h560v80H200Z"))
        public val download: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val filterList: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val starFilled: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val notificationFilled: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val notification: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val certification: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val lightMode: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val externalLink: Icon = Icon(
            1.5.rem,
            1.5.rem,
            0,
            -960,
        ...
        public val passkey: Icon = Icon(
            ...
            960,
            960,
            listOf("M120-160v-112q0-34 17.5-62.5T184-378q62-31 126-46.5T440-440q20 0 40 1.5t40 4.5q-4 58 21 109.5t73 84.5v80H120ZM760-40l-60-60v-186q-44-13-72-49.5T600-420q0-58 41-99t99-41q58 0 99 41t41 99q0 45-25.5 80T790-290l50 50-60 60 60 60-80 80ZM440-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47Zm300 80q17 0 28.5-11.5T780-440q0-17-11.5-28.5T740-480q-17 0-28.5 11.5T700-440q0 17 11.5 28.5T740-400Z")
        )
    }
...
public data class ImageVector(
    ...
    public fun color(fillColor: Paint? = null, strokeColor: Color? = null, strokeWidth: Double? = null): ImageVector =
        copy(paths = paths.map { it.copy(fillColor = fillColor, strokeColor = strokeColor, strokeWidth = strokeWidth) })

    public data class Path(
        public val fillColor: Paint? = null,
        public val strokeColor: Color? = null,
        public val strokeWidth: Double? = null,
        public val strokeCap: Icon.StrokeLineCap? = null,
        public val path: String
    )
}
...
public data class SizeConstraints(
    public val minWidth: Dimension? = null,
    public val maxWidth: Dimension? = null,
    public val minHeight: Dimension? = null,
    public val maxHeight: Dimension? = null,
    public val aspectRatio: Double? = null,
...
public data class PopoverPreferredDirection(
    public val horizontal: Boolean = false,
    public val after: Boolean = true,
    public val align: Align = Align.End,
) {
    public companion object {
...
public data class KeyboardHints(
    public val case: KeyboardCase = KeyboardCase.None,
    public val type: KeyboardType = KeyboardType.Text,
    public val autocomplete: AutoComplete? = null,
...
public data class NavGroup(
    public override val title: ReactiveContext.() -> String,
    public override val icon: ReactiveContext.() -> Icon,
    public override val count: (ReactiveContext.() -> Int?)? = null,
    public override val hidden: (ReactiveContext.() -> Boolean)? = { false },
    public override val weight: Float? = null,
    public val children: ReactiveContext.() -> List<NavElement>,
) : NavElement {
...
public data class NavLink(
    ...
    public override val hidden: (ReactiveContext.() -> Boolean)? = { false },
    public override val weight: Float? = null,
    public val destination: ReactiveContext.() -> () -> Page,
) : NavElement {
...
public data class NavExternal(
    ...
    public override val count: (ReactiveContext.() -> Int?)? = null,
    public override val hidden: (ReactiveContext.() -> Boolean)? = { false },
    public override val weight: Float?,
    public val to: ReactiveContext.() -> String,
) : NavElement
...
public data class NavAction(
    ...
    public override val hidden: (ReactiveContext.() -> Boolean)? = { false },
    public override val weight: Float? = null,
    public val onSelect: suspend () -> Unit,
) : NavElement {
...
public data class NavCustom(
    public override val title: ReactiveContext.() -> String = { "" },
    public override val icon: ReactiveContext.() -> Icon = { Icon.moreHoriz },
    public override val count: (ReactiveContext.() -> Int?)? = null,
    public override val hidden: (ReactiveContext.() -> Boolean)? = { false },
    public override val weight: Float? = null,
    public val square: ViewWriter.() -> Unit,
    public val long: ViewWriter.() -> Unit = square,
    public val tall: ViewWriter.() -> Unit = square,
) : NavElement

public fun ExpandingNavSpace(): NavCustom = NavCustom(
    weight = 1f,
    square = { space() }
)
...
public value class Dimension(public val value: DimensionRaw) : Comparable<Dimension> {
    public override fun compareTo(other: Dimension): Int = this.px.compareTo(other.px)
}
