...
) = context.overlay(modal, transition = transition, body = content)
...
@Deprecated("use directly through context", ReplaceWith("context.rawPopover(transition, content)")) fun ElementWriter.rawPopover(transition: ScreenTransitions, content: ElementWriter.() -> Unit) = context.rawPopover(transition, true, content)
...
@Deprecated("use directly through context", ReplaceWith("context.rawPopover(transition, content)")) fun Element.rawPopover(transition: ScreenTransitions, content: ElementWriter.() -> Unit) = context.rawPopover(transition, true, content)
...
@Deprecated("use directly through context", ReplaceWith("context.rawPopover(transition, content)")) fun ContainerElement.rawPopover(transition: ScreenTransitions, content: ElementWriter.() -> Unit) = context.rawPopover(transition, true, content)
