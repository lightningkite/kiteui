...
public fun Button.buttonDriverActions(): AiDriver.Actions = buildMap {
...
public fun TextInput.textInputDriverActions(): AiDriver.Actions = buildMap {
...
public fun TextArea.textAreaDriverActions(): AiDriver.Actions = buildMap {
    put("setValue") { args -> content.set(args.joinToString(" ")); "OK" }
...
public fun Checkbox.checkboxDriverActions(): AiDriver.Actions = mapOf(
...
public fun RadioButton.radioDriverActions(): AiDriver.Actions = mapOf(
...
public fun Switch.switchDriverActions(): AiDriver.Actions = mapOf(
    "toggle" to { checked.set(!checked.value); "OK" },
    "setValue" to { args ->
        val v = args.firstOrNull()?.toBooleanStrictOrNull() ?: throw DriverActionException("expected true/false argument")
        checked.set(v); "OK"
...
public fun ToggleButton.toggleDriverActions(): AiDriver.Actions = mapOf(
    "toggle" to { checked.set(!checked.value); "OK" },
    "setValue" to { args ->
        val v = args.firstOrNull()?.toBooleanStrictOrNull() ?: throw DriverActionException("expected true/false argument")
        checked.set(v); "OK"
...
public fun Slider.sliderDriverActions(): AiDriver.Actions = mapOf(
    "setValue" to { args ->
...
public fun Link.linkDriverActions(): AiDriver.Actions = buildMap {
...
public fun AutoCompleteTextField.autoCompleteDriverActions(): AiDriver.Actions = buildMap {
    put("setValue") { args -> content.set(args.joinToString(" ")); "OK" }
...
public fun NumberInput.numberInputDriverActions(): AiDriver.Actions = buildMap {
    put("setValue") { args ->
...
public fun FormattedTextInput.formattedTextInputDriverActions(): AiDriver.Actions = buildMap {
    put("setValue") { args -> content.set(args.joinToString(" ")); "OK" }
...
public fun ExternalLink.externalLinkDriverActions(): AiDriver.Actions = buildMap {
    if (to != null) put("click") {
...
public fun RadioToggleButton.radioToggleDriverActions(): AiDriver.Actions = mapOf(
    "select" to { checked.set(true); "OK" },
)
...
public fun LocalDateField.localDateDriverActions(): AiDriver.Actions = buildMap {
    put("setValue") { args ->
...
public fun LocalTimeField.localTimeDriverActions(): AiDriver.Actions = buildMap {
    put("setValue") { args ->
...
public fun LocalDateTimeField.localDateTimeDriverActions(): AiDriver.Actions = buildMap {
    put("setValue") { args ->
