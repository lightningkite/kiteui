...
@Deprecated("Use kotlinx.coroutines instead") public val delay: Unit = Unit
...
public fun encodeURIComponent(content: String): String = com.lightningkite.kotlinx.serialization.uri.encodeURIComponent(content)
...
public fun decodeURIComponent(content: String): String = com.lightningkite.kotlinx.serialization.uri.decodeURIComponent(content)
