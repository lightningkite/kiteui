...
actual class ScrollView actual constructor(
    ...
    actual fun scrollTo(element: RView, horizontal: Align, vertical: Align, animated: Boolean) = nativeScrollToElement(element, horizontal, vertical, animated)
...
internal expect fun ScrollView.nativeScrollToElement(element: RView, horizontal: Align, vertical: Align, animated: Boolean)
