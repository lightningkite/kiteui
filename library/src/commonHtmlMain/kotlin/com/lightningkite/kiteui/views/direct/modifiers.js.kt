...
actual fun ViewWriter.hintPopover(
    ...
    beforeNextElementSetup {
        ...
        native.events["contextmenu"] = {
            floating.open()
        }
        native.events["mouseenter"] = {
            floating.open()
        }
        native.events["mouseleave"] = {
            floating.close()
        }
    }
    return ViewWrapper
...
actual fun ViewWriter.sizedBox(constraints: SizeConstraints): ViewWrapper {
    beforeNextElementSetup {
        ...
        if (constraints.minHeight == null) native.style.record["min-height"] = null
        else native.style.minHeight = constraints.minHeight.value

        if (constraints.maxHeight == null) native.style.record["max-height"] = null
        else native.style.maxHeight = constraints.maxHeight.value

        if (constraints.minWidth == null) native.style.record["min-width"] = null
        else native.style.minWidth = constraints.minWidth.value

        if (constraints.maxWidth == null) native.style.record["max-width"] = null
        else native.style.maxWidth = constraints.maxWidth.value

        if (constraints.aspectRatio == null) native.style.record["aspect-ratio"] = null
        else native.style.record["aspect-ratio"] = "${constraints.aspectRatio.first} / ${constraints.aspectRatio.second}"

        if (constraints.width == null) native.style.record["width"] = null
        else native.style.width = constraints.width.value

        if (constraints.height == null) native.style.record["height"] = null
