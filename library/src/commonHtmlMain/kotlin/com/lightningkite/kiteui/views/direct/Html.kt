...
class HtmlA(context: ElementContext): RView(context) { init { native.tag = "a" } }
...
class HtmlAbbr(context: ElementContext): RView(context) { init { native.tag = "abbr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlAddress(context: ElementContext): RView(context) { init { native.tag = "address" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlArea(context: ElementContext): RView(context) { init { native.tag = "area" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlArticle(context: ElementContext): RView(context) { init { native.tag = "article" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlAside(context: ElementContext): RView(context) { init { native.tag = "aside" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlAudio(context: ElementContext): RView(context) { init { native.tag = "audio" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlB(context: ElementContext): RView(context) { init { native.tag = "b" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlBase(context: ElementContext): RView(context) { init { native.tag = "base" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlBdi(context: ElementContext): RView(context) { init { native.tag = "bdi" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlBdo(context: ElementContext): RView(context) { init { native.tag = "bdo" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlBlockquote(context: ElementContext): RView(context) { init { native.tag = "blockquote" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlBody(context: ElementContext): RView(context) { init { native.tag = "body" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlBr(context: ElementContext): RView(context) { init { native.tag = "br" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlButton(context: ElementContext): RView(context) { init { native.tag = "button" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlCanvas(context: ElementContext): RView(context) { init { native.tag = "canvas" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlCaption(context: ElementContext): RView(context) { init { native.tag = "caption" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlCite(context: ElementContext): RView(context) { init { native.tag = "cite" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlCode(context: ElementContext): RView(context) { init { native.tag = "code" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlCol(context: ElementContext): RView(context) { init { native.tag = "col" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlColgroup(context: ElementContext): RView(context) { init { native.tag = "colgroup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlData(context: ElementContext): RView(context) { init { native.tag = "data" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDatalist(context: ElementContext): RView(context) { init { native.tag = "datalist" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDd(context: ElementContext): RView(context) { init { native.tag = "dd" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDel(context: ElementContext): RView(context) { init { native.tag = "del" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDetails(context: ElementContext): RView(context) { init { native.tag = "details" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDfn(context: ElementContext): RView(context) { init { native.tag = "dfn" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDialog(context: ElementContext): RView(context) { init { native.tag = "dialog" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDiv(context: ElementContext): RView(context) { init { native.tag = "div" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDl(context: ElementContext): RView(context) { init { native.tag = "dl" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlDt(context: ElementContext): RView(context) { init { native.tag = "dt" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlEm(context: ElementContext): RView(context) { init { native.tag = "em" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlEmbed(context: ElementContext): RView(context) { init { native.tag = "embed" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlFieldset(context: ElementContext): RView(context) { init { native.tag = "fieldset" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlFigcaption(context: ElementContext): RView(context) { init { native.tag = "figcaption" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlFigure(context: ElementContext): RView(context) { init { native.tag = "figure" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlFooter(context: ElementContext): RView(context) { init { native.tag = "footer" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlForm(context: ElementContext): RView(context) { init { native.tag = "form" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlH1(context: ElementContext): RView(context) { init { native.tag = "h1" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlH2(context: ElementContext): RView(context) { init { native.tag = "h2" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlH3(context: ElementContext): RView(context) { init { native.tag = "h3" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlH4(context: ElementContext): RView(context) { init { native.tag = "h4" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlH5(context: ElementContext): RView(context) { init { native.tag = "h5" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlH6(context: ElementContext): RView(context) { init { native.tag = "h6" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlHead(context: ElementContext): RView(context) { init { native.tag = "head" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlHeader(context: ElementContext): RView(context) { init { native.tag = "header" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlHgroup(context: ElementContext): RView(context) { init { native.tag = "hgroup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlHr(context: ElementContext): RView(context) { init { native.tag = "hr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlHtml(context: ElementContext): RView(context) { init { native.tag = "html" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlI(context: ElementContext): RView(context) { init { native.tag = "i" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlIframe(context: ElementContext): RView(context) { init { native.tag = "iframe" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlImg(context: ElementContext): RView(context) { init { native.tag = "img" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlInput(context: ElementContext): RView(context) { init { native.tag = "input" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlIns(context: ElementContext): RView(context) { init { native.tag = "ins" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlKbd(context: ElementContext): RView(context) { init { native.tag = "kbd" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlLabel(context: ElementContext): RView(context) { init { native.tag = "label" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlLegend(context: ElementContext): RView(context) { init { native.tag = "legend" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlLi(context: ElementContext): RView(context) { init { native.tag = "li" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlLink(context: ElementContext): RView(context) { init { native.tag = "link" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlMain(context: ElementContext): RView(context) { init { native.tag = "main" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlMap(context: ElementContext): RView(context) { init { native.tag = "map" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlMark(context: ElementContext): RView(context) { init { native.tag = "mark" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlMenu(context: ElementContext): RView(context) { init { native.tag = "menu" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlMeta(context: ElementContext): RView(context) { init { native.tag = "meta" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlMeter(context: ElementContext): RView(context) { init { native.tag = "meter" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlNav(context: ElementContext): RView(context) { init { native.tag = "nav" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlNoscript(context: ElementContext): RView(context) { init { native.tag = "noscript" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlObject(context: ElementContext): RView(context) { init { native.tag = "object" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlOl(context: ElementContext): RView(context) { init { native.tag = "ol" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlOptgroup(context: ElementContext): RView(context) { init { native.tag = "optgroup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlOption(context: ElementContext): RView(context) { init { native.tag = "option" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlOutput(context: ElementContext): RView(context) { init { native.tag = "output" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlP(context: ElementContext): RView(context) { init { native.tag = "p" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlPicture(context: ElementContext): RView(context) { init { native.tag = "picture" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlPre(context: ElementContext): RView(context) { init { native.tag = "pre" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlProgress(context: ElementContext): RView(context) { init { native.tag = "progress" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlQ(context: ElementContext): RView(context) { init { native.tag = "q" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlRp(context: ElementContext): RView(context) { init { native.tag = "rp" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlRt(context: ElementContext): RView(context) { init { native.tag = "rt" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlRuby(context: ElementContext): RView(context) { init { native.tag = "ruby" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlS(context: ElementContext): RView(context) { init { native.tag = "s" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSamp(context: ElementContext): RView(context) { init { native.tag = "samp" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlScript(context: ElementContext): RView(context) { init { native.tag = "script" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSearch(context: ElementContext): RView(context) { init { native.tag = "search" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSection(context: ElementContext): RView(context) { init { native.tag = "section" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSelect(context: ElementContext): RView(context) { init { native.tag = "select" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSlot(context: ElementContext): RView(context) { init { native.tag = "slot" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSmall(context: ElementContext): RView(context) { init { native.tag = "small" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSource(context: ElementContext): RView(context) { init { native.tag = "source" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSpan(context: ElementContext): RView(context) { init { native.tag = "span" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlStrong(context: ElementContext): RView(context) { init { native.tag = "strong" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlStyle(context: ElementContext): RView(context) { init { native.tag = "style" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSub(context: ElementContext): RView(context) { init { native.tag = "sub" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSummary(context: ElementContext): RView(context) { init { native.tag = "summary" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlSup(context: ElementContext): RView(context) { init { native.tag = "sup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTable(context: ElementContext): RView(context) { init { native.tag = "table" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTbody(context: ElementContext): RView(context) { init { native.tag = "tbody" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTd(context: ElementContext): RView(context) { init { native.tag = "td" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTemplate(context: ElementContext): RView(context) { init { native.tag = "template" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTextarea(context: ElementContext): RView(context) { init { native.tag = "textarea" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTfoot(context: ElementContext): RView(context) { init { native.tag = "tfoot" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTh(context: ElementContext): RView(context) { init { native.tag = "th" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlThead(context: ElementContext): RView(context) { init { native.tag = "thead" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTime(context: ElementContext): RView(context) { init { native.tag = "time" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTitle(context: ElementContext): RView(context) { init { native.tag = "title" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTr(context: ElementContext): RView(context) { init { native.tag = "tr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlTrack(context: ElementContext): RView(context) { init { native.tag = "track" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlU(context: ElementContext): RView(context) { init { native.tag = "u" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlUl(context: ElementContext): RView(context) { init { native.tag = "ul" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlVar(context: ElementContext): RView(context) { init { native.tag = "var" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlVideo(context: ElementContext): RView(context) { init { native.tag = "video" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
class HtmlWbr(context: ElementContext): RView(context) { init { native.tag = "wbr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
