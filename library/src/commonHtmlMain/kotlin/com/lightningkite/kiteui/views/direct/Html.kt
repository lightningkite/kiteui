...
public class HtmlA(context: RContext): RView(context) { init { native.tag = "a" } }
...
public class HtmlAbbr(context: RContext): RView(context) { init { native.tag = "abbr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlAddress(context: RContext): RView(context) { init { native.tag = "address" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlArea(context: RContext): RView(context) { init { native.tag = "area" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlArticle(context: RContext): RView(context) { init { native.tag = "article" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlAside(context: RContext): RView(context) { init { native.tag = "aside" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlAudio(context: RContext): RView(context) { init { native.tag = "audio" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlB(context: RContext): RView(context) { init { native.tag = "b" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlBase(context: RContext): RView(context) { init { native.tag = "base" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlBdi(context: RContext): RView(context) { init { native.tag = "bdi" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlBdo(context: RContext): RView(context) { init { native.tag = "bdo" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlBlockquote(context: RContext): RView(context) { init { native.tag = "blockquote" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlBody(context: RContext): RView(context) { init { native.tag = "body" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlBr(context: RContext): RView(context) { init { native.tag = "br" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlButton(context: RContext): RView(context) { init { native.tag = "button" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlCanvas(context: RContext): RView(context) { init { native.tag = "canvas" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlCaption(context: RContext): RView(context) { init { native.tag = "caption" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlCite(context: RContext): RView(context) { init { native.tag = "cite" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlCode(context: RContext): RView(context) { init { native.tag = "code" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlCol(context: RContext): RView(context) { init { native.tag = "col" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlColgroup(context: RContext): RView(context) { init { native.tag = "colgroup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlData(context: RContext): RView(context) { init { native.tag = "data" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDatalist(context: RContext): RView(context) { init { native.tag = "datalist" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDd(context: RContext): RView(context) { init { native.tag = "dd" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDel(context: RContext): RView(context) { init { native.tag = "del" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDetails(context: RContext): RView(context) { init { native.tag = "details" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDfn(context: RContext): RView(context) { init { native.tag = "dfn" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDialog(context: RContext): RView(context) { init { native.tag = "dialog" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDiv(context: RContext): RView(context) { init { native.tag = "div" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDl(context: RContext): RView(context) { init { native.tag = "dl" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlDt(context: RContext): RView(context) { init { native.tag = "dt" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlEm(context: RContext): RView(context) { init { native.tag = "em" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlEmbed(context: RContext): RView(context) { init { native.tag = "embed" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlFieldset(context: RContext): RView(context) { init { native.tag = "fieldset" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlFigcaption(context: RContext): RView(context) { init { native.tag = "figcaption" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlFigure(context: RContext): RView(context) { init { native.tag = "figure" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlFooter(context: RContext): RView(context) { init { native.tag = "footer" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlForm(context: RContext): RView(context) { init { native.tag = "form" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlH1(context: RContext): RView(context) { init { native.tag = "h1" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlH2(context: RContext): RView(context) { init { native.tag = "h2" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlH3(context: RContext): RView(context) { init { native.tag = "h3" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlH4(context: RContext): RView(context) { init { native.tag = "h4" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlH5(context: RContext): RView(context) { init { native.tag = "h5" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlH6(context: RContext): RView(context) { init { native.tag = "h6" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlHead(context: RContext): RView(context) { init { native.tag = "head" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlHeader(context: RContext): RView(context) { init { native.tag = "header" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlHgroup(context: RContext): RView(context) { init { native.tag = "hgroup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlHr(context: RContext): RView(context) { init { native.tag = "hr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlHtml(context: RContext): RView(context) { init { native.tag = "html" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlI(context: RContext): RView(context) { init { native.tag = "i" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlIframe(context: RContext): RView(context) { init { native.tag = "iframe" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlImg(context: RContext): RView(context) { init { native.tag = "img" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlInput(context: RContext): RView(context) { init { native.tag = "input" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlIns(context: RContext): RView(context) { init { native.tag = "ins" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlKbd(context: RContext): RView(context) { init { native.tag = "kbd" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlLabel(context: RContext): RView(context) { init { native.tag = "label" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlLegend(context: RContext): RView(context) { init { native.tag = "legend" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlLi(context: RContext): RView(context) { init { native.tag = "li" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlLink(context: RContext): RView(context) { init { native.tag = "link" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlMain(context: RContext): RView(context) { init { native.tag = "main" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlMap(context: RContext): RView(context) { init { native.tag = "map" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlMark(context: RContext): RView(context) { init { native.tag = "mark" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlMenu(context: RContext): RView(context) { init { native.tag = "menu" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlMeta(context: RContext): RView(context) { init { native.tag = "meta" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlMeter(context: RContext): RView(context) { init { native.tag = "meter" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlNav(context: RContext): RView(context) { init { native.tag = "nav" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlNoscript(context: RContext): RView(context) { init { native.tag = "noscript" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlObject(context: RContext): RView(context) { init { native.tag = "object" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlOl(context: RContext): RView(context) { init { native.tag = "ol" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlOptgroup(context: RContext): RView(context) { init { native.tag = "optgroup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlOption(context: RContext): RView(context) { init { native.tag = "option" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlOutput(context: RContext): RView(context) { init { native.tag = "output" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlP(context: RContext): RView(context) { init { native.tag = "p" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlPicture(context: RContext): RView(context) { init { native.tag = "picture" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlPre(context: RContext): RView(context) { init { native.tag = "pre" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlProgress(context: RContext): RView(context) { init { native.tag = "progress" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlQ(context: RContext): RView(context) { init { native.tag = "q" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlRp(context: RContext): RView(context) { init { native.tag = "rp" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlRt(context: RContext): RView(context) { init { native.tag = "rt" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlRuby(context: RContext): RView(context) { init { native.tag = "ruby" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlS(context: RContext): RView(context) { init { native.tag = "s" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSamp(context: RContext): RView(context) { init { native.tag = "samp" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlScript(context: RContext): RView(context) { init { native.tag = "script" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSearch(context: RContext): RView(context) { init { native.tag = "search" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSection(context: RContext): RView(context) { init { native.tag = "section" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSelect(context: RContext): RView(context) { init { native.tag = "select" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSlot(context: RContext): RView(context) { init { native.tag = "slot" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSmall(context: RContext): RView(context) { init { native.tag = "small" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSource(context: RContext): RView(context) { init { native.tag = "source" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSpan(context: RContext): RView(context) { init { native.tag = "span" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlStrong(context: RContext): RView(context) { init { native.tag = "strong" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlStyle(context: RContext): RView(context) { init { native.tag = "style" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSub(context: RContext): RView(context) { init { native.tag = "sub" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSummary(context: RContext): RView(context) { init { native.tag = "summary" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlSup(context: RContext): RView(context) { init { native.tag = "sup" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTable(context: RContext): RView(context) { init { native.tag = "table" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTbody(context: RContext): RView(context) { init { native.tag = "tbody" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTd(context: RContext): RView(context) { init { native.tag = "td" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTemplate(context: RContext): RView(context) { init { native.tag = "template" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTextarea(context: RContext): RView(context) { init { native.tag = "textarea" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTfoot(context: RContext): RView(context) { init { native.tag = "tfoot" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTh(context: RContext): RView(context) { init { native.tag = "th" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlThead(context: RContext): RView(context) { init { native.tag = "thead" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTime(context: RContext): RView(context) { init { native.tag = "time" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTitle(context: RContext): RView(context) { init { native.tag = "title" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTr(context: RContext): RView(context) { init { native.tag = "tr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlTrack(context: RContext): RView(context) { init { native.tag = "track" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlU(context: RContext): RView(context) { init { native.tag = "u" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlUl(context: RContext): RView(context) { init { native.tag = "ul" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlVar(context: RContext): RView(context) { init { native.tag = "var" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlVideo(context: RContext): RView(context) { init { native.tag = "video" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
...
public class HtmlWbr(context: RContext): RView(context) { init { native.tag = "wbr" } }
@OptIn(ExperimentalContracts::class)
@ViewDsl
