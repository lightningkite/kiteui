...
public actual class DynamicCss actual constructor(basePath: String) {
    public val rules: MutableList<String> = java.util.Collections.synchronizedList(ArrayList<String>())
    public val headElements: MutableList<String> = java.util.Collections.synchronizedList(ArrayList<String>())
    ...
    public val map: java.util.concurrent.ConcurrentHashMap<String, java.util.concurrent.ConcurrentHashMap<String, java.util.concurrent.ConcurrentHashMap<String, String>>> = java.util.concurrent.ConcurrentHashMap<String, java.util.concurrent.ConcurrentHashMap<String, java.util.concurrent.ConcurrentHashMap<String, String>>>()
    ...
    @Volatile public var ruleTotal: Int = 0
